...
Use this after changing PS-01/PS-02/PS-03/PS-04 project-success benchmark docs,
scorecard templates, weekly cycle templates, or closeout templates:
...
python3 -m json.tool benchmarks/project-success/closeout-template.json >/dev/null
