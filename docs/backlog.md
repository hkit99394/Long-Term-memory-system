...
| LMSS-06 | P1 | Next | Document policy targeting for agent callers. | Principal resolution, target scope, namespace, role id, trust level, retention class, sensitivity, and source event rules are documented with examples. |
