// Generated from tools/ui/src/admin/access-panel.ts, tools/ui/src/admin/registration-panel.ts, tools/ui/src/admin-console.ts. Run npm run build in tools/ui.
"use strict";
