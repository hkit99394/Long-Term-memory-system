...
| [project-success](project-success/README.md) | PS-01 through PS-04 pilot scorecards, observation cycles, and closeout decision records for whether memory improves real project work. | Payload-safe scorecard, weekly-cycle, and closeout templates for adoption, quality, safety, operator burden, delivery impact, confidence, and final recommendation. |
